      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-6 max-w-md">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold">Welcome to Ad Library</h1>
            <p className="text-muted-foreground">
              Please sign in to access your creative inspiration hub and start collecting ads from across digital platforms.
            </p>
          </div>
        </div>
      </div>
